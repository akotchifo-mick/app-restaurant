...
<head>
  ...
  <title>Restau-U | Administrator</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand-md navbar-primary navbar-dark">
      <div class="container">
        <a href="../../index3.html" class="navbar-brand">
          <span class="brand-text font-weight-light">Restau-U</span>
        </a>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4" id="largeBande">

      <!-- Sidebar -->
      <div class="sidebar">
        <!-- Sidebar user panel (optional) -->
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <!-- Ticket Zero container -->
          <livewire:ticket-zero />
        </div>
        <!-- Sidebar Menu -->
        <nav class="mt-2">
  ...
  @livewireScripts
  <!-- REQUIRED SCRIPTS -->
  <script src="{{asset('assets/js/admin/jquery.slim.min.js')}}"></script>
