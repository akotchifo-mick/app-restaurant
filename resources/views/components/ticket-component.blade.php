<div>
    {{--
        affichage de chacun des tickets crées en ce jour par l'utilisateur
        Je voudrais ajouter un message blank en cas de tickets non encore crées c'est mieux que du vide noir
    --}}
